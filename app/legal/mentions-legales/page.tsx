...
export default function MentionsLegalesPage() {
  return (
    <article className="prose prose-sm dark:prose-invert max-w-none">
      ...
      <p>
        Le site <strong>Eagle Vanguard</strong> est édité à titre personnel et non commercial.<br />
        Contact : <a href="mailto:contact.eaglevanguard@gmail.com">contact.eaglevanguard@gmail.com</a>
      </p>
      ...
      <p>
        L&apos;ensemble des contenus présents sur Eagle Vanguard (textes, graphismes, logo, structure) sont protégés
        par le droit d&apos;auteur. Toute reproduction, même partielle, est interdite sans autorisation préalable.
      </p>

      <h2>Limitation de responsabilité</h2>
      <p>
        Eagle Vanguard est une plateforme communautaire. Les contenus publiés par les utilisateurs (descriptions,
