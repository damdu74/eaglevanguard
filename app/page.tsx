...
function WW2Flag({ country }: { country: NationCode }) {
  const flags: Record<NationCode, React.ReactNode> = {
    ...
    de: (
      // Kriegsflagge 1938–1945 (source Wikipedia commons)
      <svg viewBox="0 0 5000 3000" width="36" height="24" xmlns="http://www.w3.org/2000/svg" className="shrink-0 border border-white/10">
        <rect width="5000" height="3000" fill="#dd0000"/>
        <rect width="5000" height="750"  y="1125" fill="#fff"/>
        <rect width="750"  height="3000" x="1525" fill="#fff"/>
        <circle cx="1900" cy="1500" r="1000" fill="#fff"/>
        <rect width="5000" height="600"  y="1200" fill="#000"/>
        <rect width="600"  height="3000" x="1600" fill="#000"/>
        <circle cx="1900" cy="1500" r="925" fill="#000"/>
        <rect width="5000" height="450"  y="1275" fill="#fff"/>
        <rect width="450"  height="3000" x="1675" fill="#fff"/>
        <rect width="5000" height="300"  y="1350" fill="#000"/>
        <rect width="300"  height="3000" x="1750" fill="#000"/>
        <circle cx="1900" cy="1500" r="850" fill="#fff"/>
        <circle cx="1900" cy="1500" r="805" fill="#000"/>
        <circle cx="1900" cy="1500" r="760" fill="#fff"/>
        <path stroke="#000" strokeWidth="159.574" d="m 2111.9195,2096.1888 c -71.5181,-157.112 -115.6484,-329.3238 -126.2743,-510.5436 181.2187,10.6259 353.4316,54.7562 510.5436,126.2743 v -423.8339 c -157.112,71.5181 -329.3249,115.6483 -510.5436,126.2742 10.6259,-181.2198 54.7562,-353.4315 126.2743,-510.5436 h -423.8339 c 71.5181,157.1121 115.6483,329.3238 126.2742,510.5436 -181.2187,-10.6259 -353.4315,-54.7561 -510.5436,-126.2742 v 423.8339 c 157.1121,-71.5181 329.3249,-115.6484 510.5436,-126.2743 -10.6259,181.2198 -54.7572,353.4316 -126.2742,510.5436 z"/>
        <path stroke="#fff" strokeWidth="79.787"   d="m 2111.9195,2096.1888 c -71.5181,-157.112 -115.6484,-329.3238 -126.2743,-510.5436 181.2187,10.6259 353.4316,54.7562 510.5436,126.2743 v -423.8339 c -157.112,71.5181 -329.3249,115.6483 -510.5436,126.2742 10.6259,-181.2198 54.7562,-353.4315 126.2743,-510.5436 h -423.8339 c 71.5181,157.1121 115.6483,329.3238 126.2742,510.5436 -181.2187,-10.6259 -353.4315,-54.7561 -510.5436,-126.2742 v 423.8339 c 157.1121,-71.5181 329.3249,-115.6484 510.5436,-126.2743 -10.6259,181.2198 -54.7572,353.4316 -126.2742,510.5436 z"/>
        <path d="m 2111.9195,2096.1888 c -71.5181,-157.112 -115.6484,-329.3238 -126.2743,-510.5436 181.2187,10.6259 353.4316,54.7562 510.5436,126.2743 v -423.8339 c -157.112,71.5181 -329.3249,115.6483 -510.5436,126.2742 10.6259,-181.2198 54.7562,-353.4315 126.2743,-510.5436 h -423.8339 c 71.5181,157.1121 115.6483,329.3238 126.2742,510.5436 -181.2187,-10.6259 -353.4315,-54.7561 -510.5436,-126.2742 v 423.8339 c 157.1121,-71.5181 329.3249,-115.6484 510.5436,-126.2743 -10.6259,181.2198 -54.7572,353.4316 -126.2742,510.5436 z"/>
      </svg>
    ),
  }
