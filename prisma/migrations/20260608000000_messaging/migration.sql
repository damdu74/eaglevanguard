...
-- CreateIndex
CREATE INDEX "Conversation_user1Id_updatedAt_idx" ON "Conversation"("user1Id", "updatedAt");

-- CreateIndex
CREATE INDEX "Conversation_user2Id_updatedAt_idx" ON "Conversation"("user2Id", "updatedAt");
